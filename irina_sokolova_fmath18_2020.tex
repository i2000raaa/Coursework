...
\begin{figure}[H]
\center{\includegraphics[scale=0.6]{model_1-5.png}}
\caption{Модель}
\label{fig:model_1-5}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale=0.6]{prohibit_second_inters_ovals.png}}
\caption{}
...
\begin{figure}[H]
\center{\includegraphics[scale=0.55]{intersection_of_fields.png}}
\caption{}
